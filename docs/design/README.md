...
| 03  | [首页与输入区](03-home-and-composer.md)                 | 克制首页、上下文建议、Composer（@ / 斜杠 / 附件 / 插件 / 模型 / 权限 / 模式 / 项目 / 语音）                                                   | 清单 §3、§5.1、§5.3；总纲 §6.2、D8   |
...
3. **总纲有、截图无的功能**：使用同一组件族做渐进披露；Craft/Plan/Ask、项目、模型与高级权限的层级见 03 §4.5。
