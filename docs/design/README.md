...
| UI 基线      | [类 ChatGPT UI 设计方案](../chatgpt-like-ui-design.md) **Approved v0.5**；原 4 张截图降为 token 与既有组件的测量参考                                                                  |
...
| #   | 文档                                                    | 覆盖                                                                                                                                        | 对应总纲 / 清单                      |
| --- | ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ |
| 01  | [UI 设计系统](01-ui-design-system.md)                   | 浅色 token、对话优先布局、按需结果区、组件规格、状态/空态与可访问性                                                                          | 清单 §13；总纲 §3.8（[自建]）        |
