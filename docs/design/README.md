...
| 状态         | 01–10 已评审并回写；11 的决策已吸收，M10 代码已落地，§1.1 仍是开工前盘点。12 的 **CU-Q1–CU-Q6 已全部确认**，代码部分落地但发布关闭，剩余项见该篇 §17。实现进度以 [status.md](../status.md) 为准 |
...
| 11  | [账号与模型管理](11-account-and-models.md)              | 决策已进代码（M10a–M10c、P3.5-4）。§1.1 是开工前盘点。Q30–Q43 已决策，**Q44 未决策**。分享页仍未做 | 总纲 D9、K4、Q14；status.md        |
