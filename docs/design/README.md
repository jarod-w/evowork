...
| 11  | [账号与模型管理](11-account-and-models.md)              | **产品决策完毕，待技术评审（v0.2）**：三种上游与本机网关常驻、模型注册表四层与凭据来源、`safeStorage` 密钥存储、注册/登录（PKCE）、令牌模型、设置页、**客户端与 WEB 三面职责（§13）**、D10 / D11 草案、**Q30–Q37 全部决策**                | 总纲 D9、K4、Q14；status.md §4     |
