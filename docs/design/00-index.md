...
| **Q-01e** | **财务明细进模型上下文，客户能接受到什么程度** | 「不做训练」是合同承诺，不等于「数据不出内网」。做法见 04 §3，边界要客户点头 | 04 / 09 |
...
| # | 问题 | 建议 | 文档 |
|:-:|---|---|:---:|
| ~~Q-01c~~ | ~~M1 先接哪两家~~ | **已定：DeepSeek + GPT**。仅 DeepSeek 进交付形态 | 09 |
| Q-01d | GPT 侧走 Responses 还是 Chat Completions | **Responses**，否则两个 adapter 太像，抽象验不到 | 09 |
