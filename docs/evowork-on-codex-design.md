...
| 项               | 内容                                                                                                                                                                                             |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 版本             | v0.12（CU-Q6 确认终端与系统设置硬禁止；电脑操控六项决策完成）                                                                                                                                    |
| 日期             | 2026-09-24（v0.11–v0.7 同日；v0.6 于 2026-09-21）                                                                                                                                              |
| 作者             | li.wang                                                                                                                                                                                          |
| 状态             | Q1–Q43、Q45 已决策，**当前唯一开放项为 Q44**；电脑操控 **CU-Q1–CU-Q6 已全部确认**。Q45 **代码已接线**；电脑操控尚未实现                                                                           |
...
电脑操控当前只有设计，CU-M0–CU-M4 均未实现；现状、优先级和分发边界分别登记在
[status.md](status.md)、[work-priority.md](work-priority.md) 与 [build-and-deploy.md](build-and-deploy.md)。
