...
L.push('## 3. 解析与产物运行时');
L.push('');
L.push('办公扩展的 Python 解释器与六个包、以及 OCR 扩展，按 08 §4 **按需下载**，不随主程序。');
L.push('中文字体 Noto Sans SC 约 18MB **随基础包分发**（客户机器访问不了 GitHub raw）。');
L.push('它们各自的许可证清单如下；按需下载的部分会在下载前的确认界面里给出链接：');
L.push('');
/*
